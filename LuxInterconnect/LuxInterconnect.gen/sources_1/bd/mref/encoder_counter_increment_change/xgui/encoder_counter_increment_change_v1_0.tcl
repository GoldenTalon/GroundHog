...
proc init_gui { IPINST } {
  ...
  ipgui::add_param $IPINST -name "COUNTER_MIN" -parent ${Page_0}
...
proc update_PARAM_VALUE.COUNTER_MIN { PARAM_VALUE.COUNTER_MIN } {
	# Procedure called to update COUNTER_MIN when any of the dependent parameters in the arguments change
}

proc validate_PARAM_VALUE.COUNTER_MIN { PARAM_VALUE.COUNTER_MIN } {
	# Procedure called to validate COUNTER_MIN
	return true
}
...
proc update_MODELPARAM_VALUE.COUNTER_MIN { MODELPARAM_VALUE.COUNTER_MIN PARAM_VALUE.COUNTER_MIN } {
	# Procedure called to set VHDL generic/Verilog parameter value(s) based on TCL parameter value
	set_property value [get_property value ${PARAM_VALUE.COUNTER_MIN}] ${MODELPARAM_VALUE.COUNTER_MIN}
}
