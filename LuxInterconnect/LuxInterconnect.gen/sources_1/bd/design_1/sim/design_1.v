...
(* CORE_GENERATION_INFO = "design_1,IP_Integrator,{x_ipVendor=xilinx.com,x_ipLibrary=BlockDiagram,x_ipName=design_1,x_ipVersion=1.00.a,x_ipLanguage=VERILOG,numBlks=22,numReposBlks=17,numNonXlnxBlks=0,numHierBlks=5,maxHierDepth=1,numSysgenBlks=0,numHlsBlks=0,numHdlrefBlks=2,numPkgbdBlks=0,bdsource=USER,da_board_cnt=4,da_clkrst_cnt=1,da_mb_cnt=2,synth_mode=OOC_per_IP}" *) (* HW_HANDOFF = "design_1.hwdef" *) 
module design_1
   (JA,
    clk,
    encoder_input_0,
    ...
    sw);
  output [1:0]JA;
  (* X_INTERFACE_INFO = "xilinx.com:signal:clock:1.0 CLK.CLK CLK" *) (* X_INTERFACE_PARAMETER = "XIL_INTERFACENAME CLK.CLK, ASSOCIATED_RESET sw, CLK_DOMAIN design_1_clk_0, FREQ_HZ 100000000, FREQ_TOLERANCE_HZ 0, INSERT_VIP 0, PHASE 0.0" *) input clk;
  input [1:0]encoder_input_0;
  (* X_INTERFACE_INFO = "xilinx.com:interface:gpio:1.0 led_16bits TRI_O" *) output [15:0]led_16bits_tri_o;
  (* X_INTERFACE_INFO = "xilinx.com:signal:reset:1.0 RST.SW RST" *) (* X_INTERFACE_PARAMETER = "XIL_INTERFACENAME RST.SW, INSERT_VIP 0, POLARITY ACTIVE_LOW" *) input sw;
  ...
  wire [0:0]rst_clk_wiz_0_300M_bus_struct_reset;
  wire rst_clk_wiz_0_300M_mb_reset;
  wire [0:0]rst_clk_wiz_0_300M_peripheral_aresetn;
  ...
  design_1_axi_gpio_0_0 axi_gpio_0
       (.gpio_io_o(axi_gpio_0_GPIO_TRI_O),
        ...
        .s_axi_aresetn(rst_clk_wiz_0_300M_peripheral_aresetn),
  ...
  design_1_axi_quad_spi_0_0 axi_quad_spi_0
       (.ext_spi_clk(clk_wiz_0_spi_hdwr_ckl),
        .io0_i(1'b0),
  ...
  design_1_clk_wiz_0_0 clk_wiz_0
       (.clk_in1(clk_1),
        .lux_and_proc_clock(microblaze_0_Clk),
        .spi_hdwr_ckl(clk_wiz_0_spi_hdwr_ckl));
  ...
  design_1_ila_0_0 ila_0
       (.clk(microblaze_0_Clk),
        ...
        .probe1(axi_quad_spi_0_io0_t),
        .probe2(axi_quad_spi_0_io1_o),
        .probe3(axi_quad_spi_0_io1_t),
        .probe4(axi_quad_spi_0_ss_o),
        .probe5(axi_quad_spi_0_ss_t));
  ...
  design_1_microblaze_0_0 microblaze_0
       (.Byte_Enable(microblaze_0_dlmb_1_BE),
        ...
        .Reset(rst_clk_wiz_0_300M_mb_reset),
  ...
  microblaze_0_local_memory_imp_1K0VQXK microblaze_0_local_memory
       (.DLMB_abus(microblaze_0_dlmb_1_ABUS),
        ...
        .SYS_Rst(rst_clk_wiz_0_300M_bus_struct_reset));
  design_1_rst_clk_wiz_0_300M_0 rst_clk_wiz_0_300M
       (.aux_reset_in(1'b1),
        .bus_struct_reset(rst_clk_wiz_0_300M_bus_struct_reset),
        .dcm_locked(1'b1),
        .ext_reset_in(xlconstant_1_dout),
        .mb_debug_sys_rst(mdm_1_debug_sys_rst),
        .mb_reset(rst_clk_wiz_0_300M_mb_reset),
        .peripheral_aresetn(rst_clk_wiz_0_300M_peripheral_aresetn),
