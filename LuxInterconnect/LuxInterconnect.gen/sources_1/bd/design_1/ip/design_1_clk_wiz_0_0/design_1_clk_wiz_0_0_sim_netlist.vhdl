...
--               c:/FPGA_Projects/GroundHog/LuxInterconnect/LuxInterconnect.gen/sources_1/bd/design_1/ip/design_1_clk_wiz_0_0/design_1_clk_wiz_0_0_sim_netlist.vhdl
...
entity design_1_clk_wiz_0_0_clk_wiz is
  port (
    lux_and_proc_clock : out STD_LOGIC;
    spi_hdwr_ckl : out STD_LOGIC;
...
architecture STRUCTURE of design_1_clk_wiz_0_0_clk_wiz is
  ...
  signal lux_and_proc_clock_design_1_clk_wiz_0_0 : STD_LOGIC;
  signal spi_hdwr_ckl_design_1_clk_wiz_0_0 : STD_LOGIC;
...
clkout1_buf: unisim.vcomponents.BUFG
     port map (
      I => lux_and_proc_clock_design_1_clk_wiz_0_0,
      O => lux_and_proc_clock
    );
clkout2_buf: unisim.vcomponents.BUFG
     port map (
      I => spi_hdwr_ckl_design_1_clk_wiz_0_0,
      O => spi_hdwr_ckl
    );
mmcm_adv_inst: unisim.vcomponents.MMCME2_ADV
    generic map(
      ...
      CLKOUT0 => lux_and_proc_clock_design_1_clk_wiz_0_0,
      CLKOUT0B => NLW_mmcm_adv_inst_CLKOUT0B_UNCONNECTED,
      CLKOUT1 => spi_hdwr_ckl_design_1_clk_wiz_0_0,
...
inst: entity work.design_1_clk_wiz_0_0_clk_wiz
     port map (
      clk_in1 => clk_in1,
      lux_and_proc_clock => lux_and_proc_clock,
      spi_hdwr_ckl => spi_hdwr_ckl
    );
end STRUCTURE;
