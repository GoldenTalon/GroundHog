...
entity decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_ST7735_state_output is
  port (
    axi_stream_data : out STD_LOGIC_VECTOR ( 0 to 0 );
...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix is
  signal \^axi_stream_data\ : STD_LOGIC_VECTOR ( 6 to 6 );
...
begin
  ...
  axi_stream_data(5) <= \^axi_stream_data\(6);
  axi_stream_data(4) <= \^axi_stream_data\(6);
  axi_stream_data(3) <= \^axi_stream_data\(6);
  axi_stream_data(2) <= \^axi_stream_data\(6);
  axi_stream_data(1) <= \^axi_stream_data\(6);
  axi_stream_data(0) <= \^axi_stream_data\(6);
