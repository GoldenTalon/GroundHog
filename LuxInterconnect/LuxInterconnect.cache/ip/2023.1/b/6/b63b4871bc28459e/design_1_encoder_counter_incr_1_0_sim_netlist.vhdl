...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_encoder_counter_increment_change is
  ...
  signal \button_debounce_counter[6]_i_2_n_0\ : STD_LOGIC;
  signal \button_debounce_counter[7]_i_1_n_0\ : STD_LOGIC;
  signal \button_debounce_counter[7]_i_2_n_0\ : STD_LOGIC;
  signal \button_debounce_counter[7]_i_3_n_0\ : STD_LOGIC;
  ...
  attribute SOFT_HLUTNM of \button_debounce_counter[0]_i_1\ : label is "soft_lutpair2";
  attribute SOFT_HLUTNM of \button_debounce_counter[1]_i_1\ : label is "soft_lutpair2";
  attribute SOFT_HLUTNM of \button_debounce_counter[4]_i_2\ : label is "soft_lutpair3";
  attribute SOFT_HLUTNM of \button_debounce_counter[5]_i_1\ : label is "soft_lutpair1";
  attribute SOFT_HLUTNM of \button_debounce_counter[5]_i_2\ : label is "soft_lutpair3";
  attribute SOFT_HLUTNM of \button_debounce_counter[6]_i_2\ : label is "soft_lutpair6";
  attribute SOFT_HLUTNM of \button_debounce_counter[7]_i_2\ : label is "soft_lutpair1";
  attribute SOFT_HLUTNM of \button_debounce_counter[9]_i_3\ : label is "soft_lutpair6";
  ...
  attribute SOFT_HLUTNM of \counter[15]_i_2\ : label is "soft_lutpair4";
  ...
  attribute SOFT_HLUTNM of \counter[15]_i_7\ : label is "soft_lutpair4";
  ...
  attribute SOFT_HLUTNM of \stable_input[0]_i_1\ : label is "soft_lutpair5";
  attribute SOFT_HLUTNM of \stable_input[1]_i_1\ : label is "soft_lutpair5";
begin
...
\button_debounce_counter[0]_i_1\: unisim.vcomponents.LUT4
    generic map(
      ...
      I2 => \button_debounce_counter[4]_i_2_n_0\,
      I3 => button_debounce_counter(0),
      O => \button_debounce_counter[0]_i_1_n_0\
    );
\button_debounce_counter[1]_i_1\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"00ABAB00"
    )
        port map (
      I0 => \button_debounce_counter[4]_i_2_n_0\,
      I1 => button_debounce_counter(3),
...
\button_debounce_counter[2]_i_1\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"00ABABABAB000000"
    )
        port map (
      I0 => \button_debounce_counter[4]_i_2_n_0\,
      I1 => button_debounce_counter(3),
      I2 => button_debounce_counter(4),
      I3 => button_debounce_counter(1),
      I4 => button_debounce_counter(0),
      I5 => button_debounce_counter(2),
      O => \button_debounce_counter[2]_i_1_n_0\
    );
\button_debounce_counter[3]_i_1\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"2AAA80002AAAC000"
    )
        port map (
      I0 => \button_debounce_counter[4]_i_2_n_0\,
      I1 => button_debounce_counter(1),
      I2 => button_debounce_counter(0),
...
\button_debounce_counter[4]_i_2\: unisim.vcomponents.LUT5
    generic map(
      ...
      I1 => button_debounce_counter(9),
      I2 => button_debounce_counter(8),
      I3 => button_debounce_counter(7),
      I4 => button_debounce_counter(5),
      O => \button_debounce_counter[4]_i_2_n_0\
    );
\button_debounce_counter[5]_i_1\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"888F3333"
    )
        port map (
      ...
      I2 => button_debounce_counter(3),
      I3 => button_debounce_counter(4),
      I4 => button_debounce_counter(5),
      O => \button_debounce_counter[5]_i_1_n_0\
    );
\button_debounce_counter[5]_i_2\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"7FFF"
    )
        port map (
...
\button_debounce_counter[6]_i_1\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"F0101F1FF0F0F0F0"
    )
        port map (
      I0 => button_debounce_counter(4),
      I1 => button_debounce_counter(3),
      I2 => button_debounce_counter(6),
      I3 => \button_debounce_counter[6]_i_2_n_0\,
      I4 => \button_debounce_counter[9]_i_2_n_0\,
      I5 => button_debounce_counter(5),
      O => \button_debounce_counter[6]_i_1_n_0\
    );
\button_debounce_counter[6]_i_2\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"7F"
    )
        port map (
      ...
      O => \button_debounce_counter[6]_i_2_n_0\
    );
\button_debounce_counter[7]_i_1\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"CCCCCCCC4CCC7777"
    )
        port map (
      I0 => \button_debounce_counter[7]_i_2_n_0\,
      I1 => button_debounce_counter(7),
      I2 => button_debounce_counter(8),
      I3 => button_debounce_counter(9),
      I4 => \button_debounce_counter[9]_i_2_n_0\,
      I5 => \button_debounce_counter[7]_i_3_n_0\,
      O => \button_debounce_counter[7]_i_1_n_0\
    );
\button_debounce_counter[7]_i_2\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"E"
    )
        port map (
      ...
      O => \button_debounce_counter[7]_i_2_n_0\
    );
\button_debounce_counter[7]_i_3\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"7"
    )
        port map (
      I0 => button_debounce_counter(5),
      I1 => button_debounce_counter(6),
      O => \button_debounce_counter[7]_i_3_n_0\
    );
\button_debounce_counter[8]_i_1\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"F043F043F043F0F3"
    )
        port map (
      I0 => button_debounce_counter(9),
      I1 => \button_debounce_counter[9]_i_2_n_0\,
...
\button_debounce_counter[9]_i_2\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"7FFFFFFF"
    )
        port map (
...
\button_debounce_counter[9]_i_3\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"7F"
    )
        port map (
...
\button_press_count[1]_i_1\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"0054"
    )
        port map (
      ...
      I1 => button_debounce_counter(3),
      I2 => button_debounce_counter(4),
      I3 => \button_debounce_counter[4]_i_2_n_0\,
...
button_stable_i_1: unisim.vcomponents.LUT5
    generic map(
      INIT => X"FFAB00A8"
    )
        port map (
