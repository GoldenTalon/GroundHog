...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_encoder_counter_increment_change is
  ...
  attribute SOFT_HLUTNM of button_press_count : label is "soft_lutpair3";
  attribute SOFT_HLUTNM of \button_press_count[0]_i_1\ : label is "soft_lutpair4";
  ...
  attribute SOFT_HLUTNM of \increment_value[13]_i_1\ : label is "soft_lutpair4";
  attribute SOFT_HLUTNM of \increment_value[6]_i_1\ : label is "soft_lutpair3";
...
\stable_input[1]_i_4\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"0155FFFFFFFFFFFF"
    )
        port map (
