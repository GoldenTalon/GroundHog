...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_encoder_counter_increment_change is
  ...
  signal \_inferred__1/i___2_carry__6_n_1\ : STD_LOGIC;
  signal \_inferred__1/i___2_carry__6_n_2\ : STD_LOGIC;
  signal \_inferred__1/i___2_carry__6_n_3\ : STD_LOGIC;
  ...
  signal counter0_in : STD_LOGIC_VECTOR ( 31 downto 0 );
  ...
  signal \NLW__inferred__1/i___2_carry__6_CO_UNCONNECTED\ : STD_LOGIC_VECTOR ( 3 to 3 );
  ...
  attribute METHODOLOGY_DRC_VIOS of \_inferred__1/i___2_carry\ : label is "{SYNTH-8 {cell *THIS*}}";
  attribute ADDER_THRESHOLD of \_inferred__1/i___2_carry__0\ : label is 35;
  attribute METHODOLOGY_DRC_VIOS of \_inferred__1/i___2_carry__0\ : label is "{SYNTH-8 {cell *THIS*}}";
  attribute ADDER_THRESHOLD of \_inferred__1/i___2_carry__1\ : label is 35;
  attribute METHODOLOGY_DRC_VIOS of \_inferred__1/i___2_carry__1\ : label is "{SYNTH-8 {cell *THIS*}}";
  attribute ADDER_THRESHOLD of \_inferred__1/i___2_carry__2\ : label is 35;
  attribute METHODOLOGY_DRC_VIOS of \_inferred__1/i___2_carry__2\ : label is "{SYNTH-8 {cell *THIS*}}";
  attribute ADDER_THRESHOLD of \_inferred__1/i___2_carry__3\ : label is 35;
  attribute METHODOLOGY_DRC_VIOS of \_inferred__1/i___2_carry__3\ : label is "{SYNTH-8 {cell *THIS*}}";
  attribute ADDER_THRESHOLD of \_inferred__1/i___2_carry__4\ : label is 35;
  attribute METHODOLOGY_DRC_VIOS of \_inferred__1/i___2_carry__4\ : label is "{SYNTH-8 {cell *THIS*}}";
  attribute ADDER_THRESHOLD of \_inferred__1/i___2_carry__5\ : label is 35;
  attribute METHODOLOGY_DRC_VIOS of \_inferred__1/i___2_carry__5\ : label is "{SYNTH-8 {cell *THIS*}}";
  attribute ADDER_THRESHOLD of \_inferred__1/i___2_carry__6\ : label is 35;
  attribute METHODOLOGY_DRC_VIOS of \_inferred__1/i___2_carry__6\ : label is "{SYNTH-8 {cell *THIS*}}";
...
\_inferred__1/i___2_carry\: unisim.vcomponents.CARRY4
     port map (
      ...
      O(3 downto 0) => counter0_in(3 downto 0),
...
\_inferred__1/i___2_carry__0\: unisim.vcomponents.CARRY4
     port map (
      ...
      O(3 downto 0) => counter0_in(7 downto 4),
...
\_inferred__1/i___2_carry__1\: unisim.vcomponents.CARRY4
     port map (
      ...
      O(3 downto 0) => counter0_in(11 downto 8),
...
\_inferred__1/i___2_carry__2\: unisim.vcomponents.CARRY4
     port map (
      ...
      O(3 downto 0) => counter0_in(15 downto 12),
...
\_inferred__1/i___2_carry__3\: unisim.vcomponents.CARRY4
     port map (
      ...
      O(3 downto 0) => counter0_in(19 downto 16),
...
\_inferred__1/i___2_carry__4\: unisim.vcomponents.CARRY4
     port map (
      ...
      O(3 downto 0) => counter0_in(23 downto 20),
...
\_inferred__1/i___2_carry__5\: unisim.vcomponents.CARRY4
     port map (
      ...
      O(3 downto 0) => counter0_in(27 downto 24),
...
\_inferred__1/i___2_carry__6\: unisim.vcomponents.CARRY4
     port map (
      ...
      CO(3) => \NLW__inferred__1/i___2_carry__6_CO_UNCONNECTED\(3),
      CO(2) => \_inferred__1/i___2_carry__6_n_1\,
      CO(1) => \_inferred__1/i___2_carry__6_n_2\,
      CO(0) => \_inferred__1/i___2_carry__6_n_3\,
      CYINIT => '0',
      DI(3) => '0',
      DI(2) => \i___2_carry__6_i_1_n_0\,
      DI(1) => \i___2_carry__6_i_2_n_0\,
      DI(0) => \i___2_carry__6_i_3_n_0\,
      O(3 downto 0) => counter0_in(31 downto 28),
...
\i___2_carry__0_i_1\: unisim.vcomponents.LUT6
    generic map(
      ...
      I4 => default_clock_freq(5),
      I5 => counter(5),
      O => \i___2_carry__0_i_1_n_0\
    );
\i___2_carry__0_i_10\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"F66F0990"
    )
        port map (
...
\i___2_carry__0_i_11\: unisim.vcomponents.LUT6
    generic map(
      ...
      I3 => prev_state(1),
      I4 => counter(7),
      I5 => default_clock_freq(7),
      O => \i___2_carry__0_i_11_n_0\
    );
\i___2_carry__0_i_12\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"6996"
    )
        port map (
...
\i___2_carry__0_i_9\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"F66F0990"
    )
        port map (
...
\i___2_carry__1_i_7\: unisim.vcomponents.LUT6
    generic map(
      ...
      I1 => p_0_out(13),
      I2 => counter(9),
      I3 => default_clock_freq(9),
      I4 => counter(8),
      I5 => default_clock_freq(8),
...
\i___2_carry__2_i_5\: unisim.vcomponents.LUT6
    generic map(
      ...
      I1 => QEM_return(2),
      I2 => counter(15),
      I3 => default_clock_freq(15),
      I4 => counter(14),
      I5 => default_clock_freq(14),
...
\i___2_carry__3_i_5\: unisim.vcomponents.LUT6
    generic map(
      ...
      I1 => QEM_return(2),
      I2 => counter(19),
      I3 => default_clock_freq(19),
      I4 => counter(18),
      I5 => default_clock_freq(18),
...
\i___2_carry__3_i_6\: unisim.vcomponents.LUT6
    generic map(
      ...
      I1 => QEM_return(2),
      I2 => counter(18),
      I3 => default_clock_freq(18),
      I4 => counter(17),
      I5 => default_clock_freq(17),
...
\i___2_carry__4_i_4\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"96909000"
    )
        port map (
...
\i___2_carry__4_i_5\: unisim.vcomponents.LUT6
    generic map(
      ...
      I1 => QEM_return(2),
      I2 => counter(23),
      I3 => default_clock_freq(23),
      I4 => counter(22),
      I5 => default_clock_freq(22),
...
\i___2_carry__4_i_6\: unisim.vcomponents.LUT6
    generic map(
      ...
      I1 => QEM_return(2),
      I2 => counter(22),
      I3 => default_clock_freq(22),
      I4 => counter(21),
      I5 => default_clock_freq(21),
...
\i___2_carry__5_i_5\: unisim.vcomponents.LUT6
    generic map(
      ...
      I1 => QEM_return(2),
      I2 => counter(27),
      I3 => default_clock_freq(27),
      I4 => counter(26),
      I5 => default_clock_freq(26),
...
\i___2_carry__5_i_6\: unisim.vcomponents.LUT6
    generic map(
      ...
      I1 => QEM_return(2),
      I2 => counter(26),
      I3 => default_clock_freq(26),
      I4 => counter(25),
      I5 => default_clock_freq(25),
...
\i___2_carry__6_i_3\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"96909000"
    )
        port map (
...
\i___2_carry__6_i_4\: unisim.vcomponents.LUT6
    generic map(
      ...
      I1 => QEM_return(2),
      I2 => counter(31),
      I3 => default_clock_freq(31),
      I4 => counter(30),
      I5 => default_clock_freq(30),
...
\i___2_carry__6_i_5\: unisim.vcomponents.LUT6
    generic map(
      ...
      I1 => QEM_return(2),
      I2 => counter(30),
      I3 => default_clock_freq(30),
      I4 => counter(29),
      I5 => default_clock_freq(29),
...
\i___2_carry__6_i_6\: unisim.vcomponents.LUT6
    generic map(
      ...
      I1 => QEM_return(2),
      I2 => counter(29),
      I3 => default_clock_freq(29),
      I4 => counter(28),
      I5 => default_clock_freq(28),
...
\i___2_carry__6_i_7\: unisim.vcomponents.LUT6
    generic map(
      ...
      I3 => default_clock_freq(28),
      I4 => counter(27),
      I5 => default_clock_freq(27),
      O => \i___2_carry__6_i_7_n_0\
    );
\i___2_carry__6_i_8\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"8888E88EE88E8888"
    )
        port map (
...
\i___2_carry_i_1\: unisim.vcomponents.LUT6
    generic map(
      ...
      I3 => QEM_return(2),
      I4 => default_clock_freq(1),
      I5 => counter(1),
      O => \i___2_carry_i_1_n_0\
    );
\i___2_carry_i_10\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"0990F66FF66F0990"
    )
        port map (
